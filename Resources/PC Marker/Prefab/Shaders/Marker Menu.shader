...
Shader "Marker Menu"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float ifLocalVar55_g47 = 0;
			if( length( abs( ( i.vertexColor - color11 ) ) ) <= 0.005 )
				ifLocalVar55_g47 = 1.0;
			else
				ifLocalVar55_g47 = 0.0;
			float lerpResult59_g47 = lerp( 0.0 , ifLocalVar55_g47 , 1.0);
			...
			float ifLocalVar55_g43 = 0;
			if( length( abs( ( i.vertexColor - color70 ) ) ) <= 0.005 )
				ifLocalVar55_g43 = 1.0;
			else
				ifLocalVar55_g43 = 0.0;
			float lerpResult59_g43 = lerp( 0.0 , ifLocalVar55_g43 , 1.0);
			float4 Slider108 = ( ( lerpResult99 * SliderMask102 ) + ( lerpResult59_g43 * SpriteSheet17 ) );
			float4 color6 = IsGammaSpace() ? float4(0,1,1,1) : float4(0,1,1,1);
			float ifLocalVar55_g49 = 0;
			if( length( abs( ( i.vertexColor - color6 ) ) ) <= 0.005 )
				ifLocalVar55_g49 = 1.0;
			else
				ifLocalVar55_g49 = 0.0;
			float lerpResult59_g49 = lerp( 0.0 , ifLocalVar55_g49 , 1.0);
			float temp_output_75_0 = lerpResult59_g49;
			float4 Background195 = ( temp_output_75_0 * _BackgroundColor );
			float4 color36 = IsGammaSpace() ? float4(1,0,0,1) : float4(1,0,0,1);
			float ifLocalVar55_g48 = 0;
			if( length( abs( ( i.vertexColor - color36 ) ) ) <= 0.005 )
				ifLocalVar55_g48 = 1.0;
			else
				ifLocalVar55_g48 = 0.0;
			float lerpResult59_g48 = lerp( 0.0 , ifLocalVar55_g48 , 1.0);
			...
			float4 SpaceButton1219 = ( lerpResult59_g48 * lerpResult217 );
			float4 color37 = IsGammaSpace() ? float4(0.9137256,0,0,1) : float4(0.8148469,0,0,1);
			float ifLocalVar55_g38 = 0;
			if( length( abs( ( i.vertexColor - color37 ) ) ) <= 0.005 )
				ifLocalVar55_g38 = 1.0;
			else
				ifLocalVar55_g38 = 0.0;
			float lerpResult59_g38 = lerp( 0.0 , ifLocalVar55_g38 , 1.0);
			...
			float4 SpaceButton2237 = ( lerpResult59_g38 * lerpResult235 );
			float4 color38 = IsGammaSpace() ? float4(0.8588236,0,0,1) : float4(0.708376,0,0,1);
			float ifLocalVar55_g46 = 0;
			if( length( abs( ( i.vertexColor - color38 ) ) ) <= 0.005 )
				ifLocalVar55_g46 = 1.0;
			else
				ifLocalVar55_g46 = 0.0;
			float lerpResult59_g46 = lerp( 0.0 , ifLocalVar55_g46 , 1.0);
			...
			float4 SpaceButton3253 = ( lerpResult59_g46 * lerpResult251 );
			float4 color40 = IsGammaSpace() ? float4(0.8156863,0,0,1) : float4(0.6307572,0,0,1);
			float ifLocalVar55_g33 = 0;
			if( length( abs( ( i.vertexColor - color40 ) ) ) <= 0.005 )
				ifLocalVar55_g33 = 1.0;
			else
				ifLocalVar55_g33 = 0.0;
			float lerpResult59_g33 = lerp( 0.0 , ifLocalVar55_g33 , 1.0);
			...
			float4 SpaceButton4269 = ( lerpResult59_g33 * lerpResult267 );
			float4 color39 = IsGammaSpace() ? float4(0.7529413,0,0,1) : float4(0.5271155,0,0,1);
			float ifLocalVar55_g37 = 0;
			if( length( abs( ( i.vertexColor - color39 ) ) ) <= 0.005 )
				ifLocalVar55_g37 = 1.0;
			else
				ifLocalVar55_g37 = 0.0;
			float lerpResult59_g37 = lerp( 0.0 , ifLocalVar55_g37 , 1.0);
			...
			float4 SpaceButton5285 = ( lerpResult59_g37 * lerpResult283 );
			float4 color41 = IsGammaSpace() ? float4(0.7019608,0,0,1) : float4(0.4507858,0,0,1);
			float ifLocalVar55_g35 = 0;
			if( length( abs( ( i.vertexColor - color41 ) ) ) <= 0.005 )
				ifLocalVar55_g35 = 1.0;
			else
				ifLocalVar55_g35 = 0.0;
			float lerpResult59_g35 = lerp( 0.0 , ifLocalVar55_g35 , 1.0);
			...
			float4 SpaceButton6301 = ( lerpResult59_g35 * lerpResult299 );
			float4 color42 = IsGammaSpace() ? float4(0.6588235,0,0,1) : float4(0.3915725,0,0,1);
			float ifLocalVar55_g32 = 0;
			if( length( abs( ( i.vertexColor - color42 ) ) ) <= 0.005 )
				ifLocalVar55_g32 = 1.0;
			else
				ifLocalVar55_g32 = 0.0;
			float lerpResult59_g32 = lerp( 0.0 , ifLocalVar55_g32 , 1.0);
			...
			float4 SpaceButton7317 = ( lerpResult59_g32 * lerpResult315 );
			float4 color43 = IsGammaSpace() ? float4(0.5882353,0,0,1) : float4(0.3049874,0,0,1);
			float ifLocalVar55_g34 = 0;
			if( length( abs( ( i.vertexColor - color43 ) ) ) <= 0.005 )
				ifLocalVar55_g34 = 1.0;
			else
				ifLocalVar55_g34 = 0.0;
			float lerpResult59_g34 = lerp( 0.0 , ifLocalVar55_g34 , 1.0);
			...
			float4 SpaceButton8333 = ( lerpResult59_g34 * lerpResult331 );
			float4 temp_output_69_0 = ( ( PenButton119 + PenButton2123 + PenButton3140 + PenButton4152 + PenButton5162 + PenButton6172 ) + Slider108 + Background195 + ( SpaceButton1219 + SpaceButton2237 + SpaceButton3253 + SpaceButton4269 + SpaceButton5285 + SpaceButton6301 + SpaceButton7317 + SpaceButton8333 ) );
...
/*ASEBEGIN
Version=18935
3734;107;2209;1205;960.3737;1522.117;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;2;-2073.291,-1256.609;Inherit;True;Property;_SpriteSheet;Sprite Sheet;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;114;-2013.411,-1020.505;Inherit;False;Property;_SelectedColor;Selected Color;5;1;[HDR];Create;True;0;0;0;False;0;False;0.1223032,1,0,1;0.1223032,1,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;105;-1032.341,-896.7032;Inherit;False;Property;_SliderValue;Slider Value;6;0;Create;True;0;0;0;False;0;False;0.3711113;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;163;-3645.87,1195.778;Inherit;False;1083.432;530.1389;Comment;9;172;171;170;169;168;166;165;164;16;Clear Button;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;202;-2126.879,-683.0515;Inherit;False;967.0037;444.1973;Comment;6;6;75;78;76;195;197;Background;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;96;-314.4492,-1007.9;Inherit;False;Property;_SliderForegroundColor;Slider Foreground Color;3;0;Create;True;0;0;0;False;0;False;0.6415094,0.6415094,0.6415094,0;0.4811321,0.4811321,0.4811321,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;166;-3370.362,1609.917;Inherit;False;Property;_ClearSelected;Clear Selected;11;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;129;-3352.405,-227.5347;Inherit;False;Property;_EraserSelected;Eraser Selected;8;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;329;-1257.237,6392.667;Inherit;False;Property;_Space8Selected;Space 8 Selected;20;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;136;-3376.132,349.3133;Inherit;False;Property;_SizeSelected;Size Selected;9;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;111;-3365.48,-806.5218;Inherit;False;Property;_PenSelected;Pen Selected;7;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;-3380.417,991.0122;Inherit;False;Property;_SpaceSelected;Space Selected;12;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;233;-2823.414,4169.519;Inherit;False;Property;_Space2Selected;Space 2 Selected;14;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;281;-1244.041,3797.488;Inherit;False;Property;_Space5Selected;Space 5 Selected;17;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;265;-2858.82,5833.983;Inherit;False;Property;_Space4Selected;Space 4 Selected;16;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;297;-1233.228,4673.361;Inherit;False;Property;_Space6Selected;Space 6 Selected;18;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;95;-318.0103,-1188.604;Inherit;False;Property;_SliderBackgroundColor;Slider Background Color;4;0;Create;True;0;0;0;False;0;False;0.3018868,0.3018868,0.3018868,0;0.735849,0.735849,0.735849,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;249;-2846.366,5001.518;Inherit;False;Property;_Space3Selected;Space 3 Selected;15;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;313;-1251.25,5574.464;Inherit;False;Property;_Space7Selected;Space 7 Selected;19;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;146;-2950.087,2367.766;Inherit;False;Property;_ColorSelected;Color Selected;10;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;214;-2791.295,3336.89;Inherit;False;Property;_Space1Selected;Space 1 Selected;13;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;170;-3281.765,1245.778;Inherit;False;Vertex Color Picker;-1;;42;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;298;-1223.83,4230.922;Inherit;False;Vertex Color Picker;-1;;35;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;330;-1249.062,5950.227;Inherit;False;Vertex Color Picker;-1;;34;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;20;-3263.807,-591.6738;Inherit;False;Vertex Color Picker;-1;;36;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;234;-2814.016,3727.081;Inherit;False;Vertex Color Picker;-1;;38;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;266;-2849.422,5391.544;Inherit;False;Vertex Color Picker;-1;;33;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;282;-1234.643,3355.049;Inherit;False;Vertex Color Picker;-1;;37;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;314;-1241.852,5132.024;Inherit;False;Vertex Color Picker;-1;;32;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;250;-2836.968,4559.078;Inherit;False;Vertex Color Picker;-1;;46;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;71;-16.31581,-559.4285;Inherit;False;Vertex Color Picker;-1;;43;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;160;-3291.82,626.8738;Inherit;False;Vertex Color Picker;-1;;39;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;150;-2919.689,1869.327;Inherit;False;Vertex Color Picker;-1;;45;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;138;-3287.535,-14.82551;Inherit;False;Vertex Color Picker;-1;;44;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;3;-3258.338,-1151.254;Inherit;False;Vertex Color Picker;-1;;47;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;216;-2781.897,2894.451;Inherit;False;Vertex Color Picker;-1;;48;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;78;-1854.201,-450.8545;Inherit;False;Property;_BackgroundColor;Background Color;2;0;Create;True;0;0;0;False;0;False;0.2641509,0.2641509,0.2641509,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;75;-1840.432,-633.0518;Inherit;False;Vertex Color Picker;-1;;49;67fddad07bd5ca74290a1d9d00adbc35;0;2;61;FLOAT;1;False;2;COLOR;1,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;171;-2949.271,1292.314;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;172;-2786.438,1286.895;Inherit;False;PenButton6;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;76;-1546.201,-557.8542;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;174;-551.7289,804.3864;Inherit;False;162;PenButton5;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;120;-549.5658,496.2847;Inherit;False;119;PenButton;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;195;-1383.873,-538.9817;Inherit;False;Background;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;173;-553.7289,727.3864;Inherit;False;152;PenButton4;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;141;-552.9574,653.4546;Inherit;False;140;PenButton3;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;175;-548.7289,883.3865;Inherit;False;172;PenButton6;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;339;-597.0543,1510.792;Inherit;False;317;SpaceButton7;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;122;-553.4731,575.3767;Inherit;False;123;PenButton2;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-255.3352,656.5231;Inherit;False;6;6;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;196;-285.861,980.8474;Inherit;False;195;Background;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;69;-49.54129,893.0626;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;936.4092,628.5735;Float;False;True;-1;2;ASEMaterialInspector;0;0;Unlit;Marker Menu;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;TransparentCutout;;Geometry;All;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=709195F51CC01C19301FAF22DBF120564F244487